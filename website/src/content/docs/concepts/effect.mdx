...
<Learn learn={["Why a Ramose call does nothing until something runs it", "The three places you run one: hooks, Effect.runPromise, yield*", "How to handle an error by name"]} before={[{ href: "/getting-started/first-app/", label: "Build your first app" }]} minutes={5} />
