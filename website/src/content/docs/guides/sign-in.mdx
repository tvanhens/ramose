...
<Learn learn={["Which JWT fields Ramose verifies", "How web and MCP clients obtain the same principal identity", "How token changes interact with offline caches and database access"]} before={[{ href: "/guides/permissions/", label: "Permissions" }]} minutes={10} />
...
The provider renews expiring tokens, shares concurrent renewals, and can reuse
