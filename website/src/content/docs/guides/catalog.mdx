...
<Learn learn={["The three constructors and what each means", "Every value type and option", "What is safe to change later"]} before={[{ href: "/getting-started/first-app/", label: "Build your first app" }]} minutes={8} />
