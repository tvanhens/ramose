...
<Learn learn={["How to define every field shape and relation", "When to use traits instead of duplicate fields", "Which schema changes are additive and which require a fresh database or migration"]} before={[{ href: "/concepts/data-model/", label: "Data model" }]} minutes={12} />
