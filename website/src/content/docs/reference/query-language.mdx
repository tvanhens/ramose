...
description: The kernel query surface — Query.q, the pipeable stdlib, named rules, and composition by delegation — and how it lowers onto the engine.
---
...
than primitive. This is the one constraint language — the pipe spelling
taught in [Read data](/guides/queries/) and the generator spelling below
