---
title: Security
description: Review identity, filtered reads, exact operation grants, MCP access, and production test hooks.
---
...
<Learn learn={["The authorization checks on every read and mutation", "How MCP errors avoid disclosure", "What to verify before production"]} before={[{ href: "/concepts/authorization/", label: "Authorization deep dive" }]} minutes={12} />
