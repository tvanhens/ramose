...
import type { CatalogEid, Eid } from "./Eid.ts";
...
export interface EffectReadDb<C extends AnyCatalog = AnyCatalog> {
...
export interface EffectDb<C extends AnyCatalog = AnyCatalog>
