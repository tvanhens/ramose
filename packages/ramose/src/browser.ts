 ...
 * here instead: the portable `ramose/db` surface. App code should import
 * `ramose/db` directly; this file exists so `import * as Ramose from "ramose"`
 * in a client bundle does not ship the deploy engine.
 *
